        ...
        for transport_from_pair, artifact_path in artifacts:
            ...
            for index, call in enumerate(calls):
                ...
                row: dict[str, Any] = {
                    ...
                    "vad_endpoint_ms": call.get("vad_endpoint_ms", ""),
                    "asr_complete_ms": call.get("asr_complete_ms", ""),
                    "llm_ttft_ms": call.get("llm_ttft_ms", ""),
                    "tts_ttfb_ms": call.get("tts_ttfb_ms", ""),
                    "total_e2e_ms": call.get("total_e2e_ms", ""),
                    "interrupted": call.get("interrupted", ""),
